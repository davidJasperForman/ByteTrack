...
def make_parser():
    ...
    parser.add_argument("--track_buffer", type=int, default=25*30, help="the frames for keep lost tracks")
    parser.add_argument("--match_thresh", type=float, default=0.8, help="matching threshold for tracking")
    parser.add_argument(
        "--aspect_ratio_thresh", type=float, default=1000, #we include all detections, since all are good.
        help="threshold for filtering out boxes of which aspect ratio are above the given value."
    )
    parser.add_argument('--min_box_area', type=float, default=1, help='filter out tiny boxes') # all detections are good.
...
def extractTracks(textFile, device):
    btDict = {}
    ...
    for key in btDict.keys():
        ...
        adjusted[:, 2] = adjusted[:, 0] + adjusted[:, 2]
...
class Predictor(object):
    ...
    def inference(self, img, timer, detect=False):
        img_info = {"id": 0}
